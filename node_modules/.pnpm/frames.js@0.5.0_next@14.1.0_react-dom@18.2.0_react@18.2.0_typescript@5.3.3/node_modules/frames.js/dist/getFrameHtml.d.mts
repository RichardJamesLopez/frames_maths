import { Frame } from './types.mjs';

interface GetFrameHtmlOptions {
 ...
 */
declare function getFrameHtml(frame: Frame, options?: GetFrameHtmlOptions): string;
/**
 ...
 */
declare function getFrameHtmlHead(frame: Frame): string;

export { type GetFrameHtmlOptions, getFrameHtml, getFrameHtmlHead };
