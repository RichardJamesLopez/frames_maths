...
function validateFrame({
  ...
  const buttonLabels = $(
    "meta[property^='fc:frame:button']:not([property$=':action']):not([property$=':target']), meta[name^='fc:frame:button']:not([name$=':action']):not([property$=':target'])"
