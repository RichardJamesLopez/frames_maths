...
type ImageAspectRatio = "1.91:1" | "1:1";
...
declare const frameErrorKeys: readonly ["fc:frame", "fc:frame:image", "fc:frame:image:aspect_ratio", "fc:frame:post_url", "fc:frame:input:text", "fc:frame:button:1", "fc:frame:button:2", "fc:frame:button:3", "fc:frame:button:4", "og:image", "og:title"];
type ErrorKeys = typeof frameErrorKeys;
type ActionButtonType = "post" | "post_redirect" | "link";
...
type FrameButtonPostRedirect = FrameButtonPost;
type FrameButton = FrameButtonPost | FrameButtonLink | FrameButtonPostRedirect | FrameButtonMint;
/** The permitted types of `buttonIndex` in a Frame POST payload response */
type ActionIndex = 1 | 2 | 3 | 4;
type FrameButtonsType = [] | [FrameButton] | [FrameButton, FrameButton] | [FrameButton, FrameButton, FrameButton] | [FrameButton, FrameButton, FrameButton, FrameButton];
...
type FrameActionDataParsedAndHubContext = FrameActionDataParsed & FrameActionHubContext;
/**
...
export { type ActionButtonType, type ActionIndex, type AddressReturnType, type ErrorKeys, type Frame, type FrameActionDataParsed, type FrameActionDataParsedAndHubContext, type FrameActionHubContext, type FrameActionPayload, type FrameButton, type FrameButtonLink, type FrameButtonMint, type FrameButtonPost, type FrameButtonPostRedirect, type FrameButtonsType, type FrameFlattened, type HubHttpUrlOptions, type ImageAspectRatio, type UserDataReturnType, frameErrorKeys };
