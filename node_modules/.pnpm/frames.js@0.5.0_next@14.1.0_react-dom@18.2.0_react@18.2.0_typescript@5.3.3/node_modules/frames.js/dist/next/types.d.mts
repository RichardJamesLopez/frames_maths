import { FrameActionPayload, ActionIndex } from '../types.mjs';
 ...
 */
type RedirectMap = Record<number | `_${number}`, string>;
/**
 * A representation of the previous frame, used in order to enable state transitions and redirects.
 */
type PreviousFrame<T extends FrameState = FrameState> = {
 ...
 */
type RedirectHandler = (action: PreviousFrame) => string | undefined;
/**
 ...
 */
type FrameReducer<T extends FrameState = FrameState> = (state: T, action: PreviousFrame) => T;
/**
...
type FrameButtonProvidedProps = (FrameButtonPostRedirectProvidedProps | FrameButtonPostProvidedProps | FrameButtonMintProvidedProps | FrameButtonLinkProvidedProps) & {
    /** defaults to post */
...
type FrameButtonLinkProvidedProps = {
    /** a label to display on the button */
    children: string | number;
    action: "link";
...
export type { Dispatch, FrameButtonAutomatedProps, FrameButtonLinkProvidedProps, FrameButtonMintProvidedProps, FrameButtonPostProvidedProps, FrameButtonPostRedirectProvidedProps, FrameButtonProvidedProps, FrameReducer, FrameState, HeadersList, NextServerPageProps, PreviousFrame, RedirectHandler, RedirectMap };
