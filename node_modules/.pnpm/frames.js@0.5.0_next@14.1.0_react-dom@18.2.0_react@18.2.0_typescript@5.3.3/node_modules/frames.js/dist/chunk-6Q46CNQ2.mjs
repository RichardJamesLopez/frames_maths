import {
  getUserDataForFid
} from "./chunk-LRHQB5K7.mjs";
import {
  getAddressForFid
} from "./chunk-KY4CUB2D.mjs";
import {
  getTokenFromUrl
} from "./chunk-Q62MVRTC.mjs";
import {
  getByteLength,
...
async function validateFrameMessage(body, options) {
  ...
  const validateMessageResponse = await fetch(
    `${optionsOrDefaults2.hubHttpUrl}/v1/validateMessage`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/octet-stream",
        ...optionsOrDefaults2.hubRequestOptions.headers
      },
